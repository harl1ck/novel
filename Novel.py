    ...
    while True:
        ...
        match choose:
            case 1 | 2 | 3:
                ...
                match chanse:
                    case 0:
                        print("Размышления о том, как же выбраться привели Катюху к мыслям о незаполненом электронном журнале,\n"
                              "незаконченной практической по C# и было не плохо сделать всё это, пока не прилетело как старосте.\n"
                              "Минус только в том, что телефона нет. Зато есть документация по шарпам, так что код можно написать на листочке))))))))))")
                        try:
                            choose = int(input("Выберите, что будет делать Катюха:\n\t"
                                               "1. Продолжить думать\n\t"
                        ...
                        match choose:
                            ...
                            case 2:
                                print("Не самое приятное и интересное дело, но важное и не то, чтобы отложное.\n"
                                      ...
                                      "За дверью послышались шорохи, а значит вернулся банан. Покрепче схватив толтенную и тяжёлую документацию,\n"
                                      "Катюха ударила, что есть сил стоило тирану войти в помещение.")
                                chanse = random.randint(0, 1)
                                match chanse:
                                    case 0:
                                        print("Банан не выстоял и пал ниц. Катюха схватила сделанные практы и сбежала...Победа!!!")
                                    case 1:
                                        print("Банана такой удар не взял и Катюха пала смертью храбрых...Проигрыш!")
                    case 1:
                        print("Думать пришлось долго, но в итоге было принято решение пождечь хату с помощью документации.\n"
