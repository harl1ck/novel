import random
from Data_Saves import lox_inven
...
def tema():
    ...
    print("Не повезло ему оказаться в трэп-хате банана...\n"
          ...
          "- Ох зря я сюда полез... - чуть не плача сказал Тёма, глаза слезились, но из-за вони нежели от грусти.\n"
    ...
    while True:
        ...
        match choose:
            case 1:
                ...
                return temacry()
            case 2:
                message = "После долгого ожидания банана и подготовки к его приходу,\n"\
            ...
            case 4:
                message = "Решив, что время нужно потратить с пользой Тёма достал ноут и начал писать ультра-код на spring.\n"\
...
def temacry():
    ...
    match chanse:
        case 0:
            message = "Тёму накуканил банан, ВЫ ПРОИГРАЛИ!"
            print(message)
        case 1:
            message = "Плач этого кита услышали соседи и вызвали 112, Тёму спасли, ПОБЕДА!!!"
            print(message)
    return message
...
def temawindow():
    ...
    match chanse:
        case 0:
            message = "Штаны оказались ненадёжным парашютом и Тёма разбился, ВЫ ПРОИГРАЛИ!"
            print(message)
        case 1:
            message = "Удивительно, но штаны парашюты спасли его жизнь. ПОБЕДА!!!"
            print(message)
    return message
    ...
    while True:
        ...
        match choose:
            case 1:
                ...
                match choice:
                    case "ДА" | "YES":
                        print("Осмотрев комнату ещё раз, Наська заметила, что что-то торчит из-за шкафа,\n"
...
def naska_102():
    ...
    match chanse:
        case 0:
            message = "Полиция не успела до прихода маньяка. ВЫ ПРОИГРАЛИ!"
            print(message)
        case 1:
            message = "Полиция приехала вовремя, Наську спасли. ПОБЕДА!!!"
            print(message)
    return message
...
def naskajavka():
    ...
    match chanse:
        case 0:
            message = "Старый носок...Теперь отсюда не выбраться......"
            print(message)
        case 1:
            message = "Связкой ключей для дверей!!!\n"\
    ...
    while True:
        ...
        match choose:
            case 1 | 2 | 3:
                ...
                match chanse:
                    case 0:
                        print("Размышления о том, как же выбраться привели Катюху к мыслям "
                        ...
                        match choose:
                            ...
                            case 2:
                                ...
                                match chanse:
                                    case 0:
                                        message = "Банан не выстоял и пал ниц. "\
                                                  "Катюха схватила сделанные практы и сбежала...Победа!!!"
                                        print(message)
                                    case 1:
                                        message = "Банана такой удар не взял и Катюха пала смертью храбрых...Проигрыш!"
                                        print(message)
                                return message
                    case 1:
                        print("Думать пришлось долго, но в итоге было принято решение "
                        ...
                        match chanse:
                            case 0:
                                message = "Соседи вызвали пожарных и Катюху спасли! Победа!!!"
                                print(message)
                            case 1:
                                message = "Катюха не подумала о путях отхода сгорела...Проигрыш!"
                                print(message)
                        return message
                break
